...
@section('content')
<h1>Filmes relacionados a "<i>{{$searchTerm}}</i>": </h1>
...
<div class="movie">
    ...
    <div class="movie-info">
            ...
            @if(isset($movie['overview']) && $movie['overview'] != '')
                <p class="description"><b>Sinopse:</b> {{$movie['overview']}}</p>
            @else 
                <p class="description">Infelizmente não conseguimos encontrar a sinopse deste filme :(</p>
            @endif
